...
- Removed Duplicate Tuff blocks that were added in SilkCraft v1.0.1
- Updated 1.21.0 loot tables to replace vanilla tools with SilkCraft's vanilla tools
