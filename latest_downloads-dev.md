...
- Added a unique boss bar for each boss added by SilkCraft
- Updated Boss bars of vanilla Bosses
- Bosses added by SilkCraft now has improved animations
- Improved animations on some mobs added by SilkCraft
- Improved structures added by SilkCraft to involve combat
...
- Re-added the Battle Tower from SilkCraft v1.0.2
