...
- Updated SilkCraft's world generation to allow placement for vanilla features
...
- Updated every string used in SilkCraft to use translations
- Updated the main menu panorama
- Reduced the rate at which Stardust Ore can generate
- **Removed the SilkCraft versions of Vanilla Tools!!**
- Updated ambient sounds for the Forest, Plains, Birch Forest, and snow biomes
- Added support for Fortune on SilkCraft ores and crops
...
- Made numerous tweaks to SilkCraft's world generation
...
- Added missing recipes for SilkCrafts' end wood types
...
- Fixed the issue where tall flowers added by SilkCraft would refuse to generate.
...
- Fixed the breaking speeds of SilkCraft's ores
