...
## Tool & Armor Tiers
SilkCraft adds a few new tiers of tools and armor. We will list them in order, from weakest to strongest.
...
### Info
Stardust is a new armor and tool tier for SilkCraft, and it is better than Netherite.
### How to obtain
